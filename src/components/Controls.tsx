    ...
    <Card>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-3">
          ...
          <Slider id="count1" min={1} max={100} step={1} value={[params.count1]} onValueChange={([v]) => handleSliderChange('count1', v)} />
        </div>
        <div className="space-y-3">
         ...
         <div className="space-y-3">
          ...
          <Slider id="count2" min={1} max={100} step={1} value={[params.count2]} onValueChange={([v]) => handleSliderChange('count2', v)} />
        </div>
