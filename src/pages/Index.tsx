...
const Index = () => {
  ...
  const [stats, setStats] = useState<Stats>({ meanKE1: 0, meanKE2: 0, timeAvgKE1: 0, timeAvgKE2: 0, oppositeCollisionsPerSec: 0, sameCollisionsPerSec: 0, oppositeCollisionsTotal: 0, sameCollisionsTotal: 0, elapsedSeconds: 0 });
